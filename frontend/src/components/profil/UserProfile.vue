      ...
      <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
        <div class="space-y-4">
          <div class="flex space-x-4">
            <div>
              ...
              <h2 class="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">Jean Michel</h2>
            </div>
          </div>
          <dl class="">
        ...
        <div class="space-y-4">
          <dl>
            ...
            <dd class="text-gray-500 dark:text-gray-400">+33 612345678</dd>
          </dl>
          <dl>
            <dt class="font-semibold text-gray-900 dark:text-white">Mon entreprise</dt>
            <dd class="text-gray-500 dark:text-gray-400">ENTREPRISE CORP, SIRET: 18673557</dd>
          </dl>
          <dl>
            <dt class="mb-1 font-semibold text-gray-900 dark:text-white">Moyen de paiement</dt>
            <dd class="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
              ...
              <div>
                <div class="text-sm">
                  <p class="mb-0.5 font-medium text-gray-900 dark:text-white">Visa terminant par 7658</p>
                  <p class="font-normal text-gray-500 dark:text-gray-400">Expire le 10/2028</p>
                </div>
              </div>
            </dd>
          </dl>
